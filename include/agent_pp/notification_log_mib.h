...
//--AgentGen BEGIN=nlmLogVariableEntry
	virtual bool		is_volatile() { return TRUE; }
    /**
     * Add a new variable to the nlmLogVariableTable with the given log entry index and variable index (1-based).
     * @param index
     *   the nlmLogEntry index associated with this variable (must already exists)
     * @param nlmLogVariableIndex
     *   the index (1..32^16-1) of the variable within the logged payload.
     * @param vb
     *   the variable with OID and value.
     */
